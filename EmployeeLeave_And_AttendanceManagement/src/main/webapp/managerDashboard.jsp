...
// Extract initials from manager name
String[] nameParts = managerName.trim().split(" ");
String initials = "";
	...
	<div class="sidebar" id="sidebar">
		...
		<ul>
			...
			<li><a href="ManagerViewEmployeesServlet" target="contentFrame"
				onclick="loadPage(this)"> <i class="fa-solid fa-users"></i> <span>View
						Employees</span>
			</a></li>

			<li><a href="createTask.jsp" target="contentFrame"
				onclick="loadPage(this)"> <i class="fa-solid fa-plus-circle"></i>
	...
	<div class="header" id="header">
		<div class="header-left">
			...
			<div class="header-title">
				<i class="fa-solid fa-briefcase"></i> Manager Portal
			</div>
		</div>

		<div class="header-right">
			<div class="header-info" title="<%=managerName%>">
