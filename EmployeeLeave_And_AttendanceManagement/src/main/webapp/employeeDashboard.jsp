...
<body>
	...
	<div class="container">
		...
		<!-- Page Subtitle -->
		<p class="page-subtitle">Manage your attendance and leave requests from here</p>

		<!-- Info Box -->
		<div class="info-box">
			<strong>ℹ️ Note:</strong> You can mark your daily attendance, apply for leaves, and view your history from the options below.
		</div>
		...
		<div class="menu-cards">
			...
			<a href="attendance.jsp" class="menu-card attendance">
			...
			<!-- CARD 2: Apply Leave -->
			<a href="applyLeave.jsp" class="menu-card leave-apply">
				<span class="icon">📝</span>
				<h3>Apply Leave</h3>
			...
			<a href="attendanceHistory?employeeId=1" class="menu-card attendance-history">
				<span class="icon">📊</span>
			...
			<!-- CARD 5: Logout -->
			<a href="logout" class="menu-card logout" onclick="return confirm('Are you sure you want to logout?');">
				<span class="icon">🚪</span>
				<h3>Logout</h3>
