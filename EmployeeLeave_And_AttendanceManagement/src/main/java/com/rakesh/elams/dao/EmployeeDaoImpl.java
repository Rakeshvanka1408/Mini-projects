...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	public Employee getEmployeeById(int id ) {
		...
		PreparedStatement ps = connection.prepareStatement(sql);
			...
			while(rs.next()) {
				emp =new Employee(rs.getInt("employee_id"),rs.getString("employee_name"),rs.getString("email"),rs.getLong("phone"),rs.getString("department"),rs.getString("designation"));
	...
	public List<Employee> getAllEmployees(){
	 ...
	 public boolean updateEmployee(Employee employee) {
	        ...
	        String sql =
	        "UPDATE employees SET employee_name=?,email=?,phone=?,department=?,designation=? WHERE employee_id=?";
